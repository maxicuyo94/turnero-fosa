...
- [ ] 1.5 Selector de tipo de vehículo en la reserva pública y administración del catálogo en Configuración.
...
- [ ] 2.1 Pruebas RED de historial por unidad, búsqueda, detección de duplicados, fusión y fusión repetida.
